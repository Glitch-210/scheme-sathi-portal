      ...
      <div className="container py-6 md:py-10">
        {!selectedApp ? (<>
            ...
            {applications.length === 0 ? (<Card>
                ...
                {applications.map((app) => (<Card key={app.id} className="cursor-pointer hover:shadow-soft transition-shadow" onClick={() => setSelectedApp(app)}>
            ...
            <Button variant="ghost" size="sm" className="gap-2 mb-6" onClick={() => setSelectedApp(null)}>
              <ArrowLeft className="h-4 w-4"/>
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <div className="bg-muted rounded-lg p-4 space-y-2 text-sm">
                    ...
                    {selectedApp.formData.aadhaar && (<div className="flex justify-between">
                ...
                <div className="border-t pt-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['submitted', 'in-review', 'approved', 'rejected'].map((status) => (<Button key={status} variant={selectedApp.status === status ? 'default' : 'outline'} size="sm" onClick={() => handleStatusChange(selectedApp.id, status)}>
